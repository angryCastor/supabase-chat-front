<template>
  ...
  >
    <template #removeicon="{ removeCallback, keydownCallback }">
      <TimesCircleIcon
        class="cursor-pointer text-base w-4 h-4 rounded-full text-surface-800 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary"
